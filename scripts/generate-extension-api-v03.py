...
def validate_schema(schema: dict[str, Any]) -> None:
    ...
    if schema["schema_format"] != "octet.extension.protocol.schema/v1":
...
def render_python(schema: dict[str, Any], source_hash: str) -> str:
    ...
    lines: list[str] = [
        '"""Generated canonical wire models and validation for octet extension API 0.3."""',
        "# @generated by scripts/generate-extension-api-v03.py; DO NOT EDIT.",
        f"# Source: protocol/extension-api-v0.3.schema.json (sha256: {source_hash})",
        "from __future__ import annotations",
        "",
...
def render_typescript_runtime(schema: dict[str, Any], source_hash: str) -> str:
    ...
    lines.extend([
        ...
        "const PRESENCE = Symbol('octet.extension.api_v03.presence'); function _presence(kind, value) { const result = kind === 'value' ? { kind, value } : { kind }; Object.defineProperty(result, PRESENCE, { value: true }); return result; } function _isPresence(value) { return Boolean(value && typeof value === 'object' && value[PRESENCE] === true); }",
...
def generated_files(schema: dict[str, Any], source_hash: str) -> dict[Path, bytes]:
    ...
    files: dict[Path, bytes] = {
        ROOT / "crates/octet-agent/src/extension_api_v03.rs": render_rust(schema, source_hash).encode("utf-8"),
        ROOT / "sdk/python/octet_extension/api_v03.py": render_python(schema, source_hash).encode("utf-8"),
