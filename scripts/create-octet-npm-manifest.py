#!/usr/bin/env python3
"""Create the signed evidence manifest for an immutable octet npm candidate."""
...
def read_release_metadata(
    ...
    if checksum_manifest.get("name") != "OCTET_SHA256SUMS" or not isinstance(
    ...
    expected_assets = {
        ...
        f"octet-{version}-x86_64-apple-darwin.tar.gz": (
            "binary",
            "x86_64-apple-darwin",
        ),
