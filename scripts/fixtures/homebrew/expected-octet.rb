...
# Release workflow ref: skaft-software/ygg/.github/workflows/release-octet.yml@refs/tags/octet-binaries-v0.7.0
...
class Octet < Formula
  ...
  on_arm do
    url "https://github.com/skaft-software/ygg/releases/download/v0.7.0/octet-0.7.0-aarch64-apple-darwin.tar.gz"
    sha256 "e7ab051b6c1c9e079171c9f264c39d954116cae49944eec831aebccac8da986b"
  end

  on_intel do
    url "https://github.com/skaft-software/ygg/releases/download/v0.7.0/octet-0.7.0-x86_64-apple-darwin.tar.gz"
