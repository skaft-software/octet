...
SOURCE = ROOT / "crates/octet-coding-agent/fixtures/providers/pi-0.84.4.json"
...
def render(inventory: dict[str, Any]) -> str:
    lines = [
        "<!-- Generated by scripts/generate-pi-provider-compatibility.py from crates/octet-coding-agent/fixtures/providers/pi-0.84.4.json; do not edit. -->",
        "",
