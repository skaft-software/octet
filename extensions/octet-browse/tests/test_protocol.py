...
from octet_browse.artifacts import PNG_SIGNATURE, ScreenshotRecord
from octet_browse.runtime import create_runtime
        ...
        self.protocol.reader.send(
            {
                ...
                "params": {
                    ...
                    "extension": {
                        "name": "octet-browse",
                        "version": "0.1.0",
                        "manifest_path": "/tmp/octet-browse/extension.toml",
                        "source": "global",
                    },
