    ...
    def command(
        ...
        *,
        ...
        if action == "reset-profile":
            ...
            confirmed = confirmation(
                "Close octet Browse and permanently reset its isolated profile?",
                "Only a sentinel-verified ~/.octet/browse/profile/ directory will be removed. Normal browser profiles are never inspected.",
                True,
            )
            if not confirmed:
                self.presentation.activity(
            ...
            return (
                "Closed octet Browse and removed its sentinel-verified isolated profile."
                if removed
