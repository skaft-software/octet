"""Hermetic subprocess harness for the octet-pi-compat bridge."""
...
def v03_contract(*, providers: bool = True, max_frame_bytes: int = 1_048_576) -> dict[str, Any]:
    ...
    from octet_extension import api_v03
    ...
    def __init__(
        ...
        *,
        ...
        if fixture_mode is not None:
            environment["OCTET_PI_FIXTURE_MODE"] = fixture_mode
        if fixture_events is not None:
            environment["OCTET_PI_FIXTURE_EVENTS"] = ",".join(fixture_events)
        ...
        self.octet_version = octet_version
        ...
        *optional_features: str,
        ...
        if self.api_version == "0.3":
            params.update(
                {
                    "api_version": "0.3",
                    "octet_version": self.octet_version,
                    "extension": {
