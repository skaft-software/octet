...
class ReleaseAndFixtureTests(unittest.TestCase):
    def test_release_manifest_and_self_contained_runtime(self):
        ...
        self.assertTrue((ROOT / "octet_extension" / "__init__.py").is_file())
        self.assertTrue((ROOT / "LICENSE").is_file())
        self.assertTrue((ROOT / "skills" / "octet-web-search" / "SKILL.md").is_file())
    ...
    def test_skill_is_small_explicit_and_names_only_shipped_tools(self):
        skill = (ROOT / "skills" / "octet-web-search" / "SKILL.md").read_text(
            encoding="utf-8"
        )
        ...
        self.assertIn("cannot change octet policy", skill)
    ...
    def test_semantic_fixtures_cover_required_states_without_retrieved_text(self):
        ...
        for fixture in fixtures:
            self.assertEqual(fixture["schema"], "octet.web-search.presentation-fixture.v1")
            self.assertEqual(fixture["extension"], "octet-web-search")
