...
not current extension authoring. Bundle `0.7.3` requires exactly octet `0.7.3`.
...
Release compatibility is recorded in `extension.toml`: bundle `0.7.3`, extension
API `0.2`, exact octet `0.7.3`.
