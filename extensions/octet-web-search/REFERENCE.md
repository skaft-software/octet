...
not current extension authoring. Bundle `0.7.0` requires exactly octet `0.7.0`.
...
Release compatibility is recorded in `extension.toml`: bundle `0.7.0`, extension
API `0.2`, exact octet `0.7.0`.
