"""Public Python API for octet executable extensions."""
...
_CURRENT_REQUEST: contextvars.ContextVar[Optional[_RequestScope]] = contextvars.ContextVar(
    "octet_extension_current_request", default=None
)
...
class Extension:
    """Define and run a dependency-free octet executable extension.
    ...
    def __init__(
        ...
        *,
        ...
        self.api_version = api_version or os.environ.get(
            "OCTET_EXTENSION_API_VERSION", DEFAULT_API_VERSION
        )
    ...
    def publish_artifact(
        ...
        *,
        ...
        """Publish bounded inline bytes or a relative scratch artifact to octet."""
    ...
    def _initialize(self, params: Any) -> dict[str, Any]:
        ...
        self._executor = ThreadPoolExecutor(
            ...
            thread_name_prefix="octet-extension-handler",
        )
        result: dict[str, Any] = {
    ...
    def _start_eof_drain(self) -> None:
        ...
        threading.Thread(target=eof_flow, name="octet-extension-eof", daemon=True).start()
