"""Bounded provider-backed search and public-web retrieval for octet-web-search.
...
def default_config_path() -> Path:
    return Path.home() / ".config" / "octet" / "octet-web-search.json"


def default_brave_credentials_path() -> Path:
    return Path.home() / ".octet" / "credentials" / "octet-web-search-brave.key"
