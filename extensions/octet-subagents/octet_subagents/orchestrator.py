"""Bounded orchestration over octet API 0.2's host-owned agent_sessions service."""
...
class Orchestrator:
    """Policy layer only; octet remains the session, persistence, and limit owner."""
                ...
                "notifications": [
                    {
                        ...
                        "message": "No stale command request was reused; the worker remains authoritative in octet.",
                    }
                ],
            }
        return {
