...
fn theme() -> ThemeOption {
    ThemeOption {
        ...
        theme: ThemeDto {
            ...
            roles: BTreeMap::from([(
                octet_serve_backend::SemanticRole::new("surface.user").unwrap(),
                ThemeRoleStyle {
...
fn bootstrap() -> HostBootstrap {
    HostBootstrap {
        ...
        projects: vec![ProjectSummary {
            id: ProjectId::new("project-octet").unwrap(),
            name: "octet".into(),
            trusted: true,
            archived: false,
            available: true,
        ...
        sessions: vec![SessionSummary {
            ...
            project_id: Some(ProjectId::new("project-octet").unwrap()),
    ...
    SessionItem {
        ...
        payload: ItemPayload::RunOutcome {
            ...
            review: CompletionReview {
                ...
                source_ids: Vec::new(),
                output_ids: vec![
                    octet_serve_backend::ArtifactId::new("artifact-report").unwrap(),
                ],
    ...
    SessionCommandEnvelope::new(
        ...
        SessionCommand::SubmitPrompt {
            input: PromptInput {
                ...
                attachments: vec![octet_serve_backend::AttachmentRef {
