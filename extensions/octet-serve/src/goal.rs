//! Durable per-session goal state for graphical octet clients.
//!
//! The storage implementation is shared with `octet-agent`. This module keeps
...
use octet_agent::{DurableGoalStore, DurableGoalStoreError, GoalAction as DurableGoalAction};
pub use octet_agent::{MAX_GOAL_OBJECTIVE_BYTES, MAX_GOAL_TURN_BUDGET};
...
pub use octet_agent::{GoalState, GoalStatus};
