//! Frontend-neutral backend contracts for the optional `octet serve` experiment.
//!
//! This crate is intentionally independent of octet's TUI and core Agent crates.
