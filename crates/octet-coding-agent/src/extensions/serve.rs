...
mod tests {
    use super::*;
    use octet_agent::{AgentError, EntryMetadata};
    use octet_ai::{AiError, AssistantMessage, Protocol, TransportPhase, UserMessage};
    use octet_serve_backend::{
    ...
    fn provider_failure_diagnostics_include_status_and_request_id() {
        ...
        let timeout_message =
            octet_agent::public_error_diagnostic(&timeout, "custom/e2e", "e2e-model");
