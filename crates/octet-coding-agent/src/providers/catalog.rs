...
//! into the single `octet_ai::ModelCatalog`; it does not maintain a second model
...
mod tests {
    ...
    fn static_models_use_only_generated_route_endpoints() {
        ...
        assert_eq!(
            deepseek
                ...
                .openai_chat_mode,
            octet_ai::OpenAiChatReasoningMode::DeepSeekThinking
        );
        ...
        assert_eq!(reasoning.min_effort, octet_ai::ReasoningEffort::High);
        assert_eq!(reasoning.max_effort, octet_ai::ReasoningEffort::High);
        assert_eq!(
    ...
    fn alternate_provider_routes_keep_private_url_and_auth_details_in_catalog() {
        ...
        assert_eq!(
            ...
            octet_ai::OpenAiChatRuntimeProfile::Mistral
        );
    ...
    fn declaration_headers_reject_credential_carriers() {
        assert!(public_headers(&[("originator", "octet")]).is_ok());
