...
struct SpeculativeBash {
    ...
    active: HashMap<octet_ai::ToolCallId, SpeculativeExecution>,
}
...
impl SpeculativeBash {
    ...
    fn note_start(&mut self, index: usize, id: octet_ai::ToolCallId, name: String) {
        if name == "bash" {
            self.partial.insert(
                index,
    ...
    fn complete(&mut self, index: usize) -> Option<(octet_ai::ToolCallId, serde_json::Value)> {
                ...
                let turn = 'consume: loop {
                    ...
                    match next {
                        ...
                        Next::Event(Some(Ok(event))) => {
                            ...
                            // `octet-ai`'s ResponseBuilder assembles the message
                            ...
                            StreamEvent::ToolCallEnd {
                                ...
                                attempt_saw_generation = true;
                                // `octet-ai` validates completed parseable calls
...
mod tests {
    ...
    async fn speculative_bash_reconciles_exact_match_and_discards_drift() {
        ...
        let id = octet_ai::ToolCallId("call_spec".into());
