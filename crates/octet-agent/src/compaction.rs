...
//! continue. The model produces the structured Markdown checkpoint; octet tracks
//! file operations deterministically and appends the XML file lists host-side.

use std::collections::BTreeSet;

use octet_ai::{AssistantPart, Media, Message, ToolResult, ToolResultPart, UserMessage, UserPart};
...
fn tool_call_text(call: &octet_ai::ToolCall) -> String {
