...
pub const TELEMETRY_SCHEMA: &str = "octet.telemetry.v1";
...
mod tests {
    ...
    fn policy_decision_records_are_secret_safe_and_machine_readable() {
        ...
        sandbox.shell_path = Some("/private/users/alice/.secrets/octet-shell".into());
        observer.on_event_for_owner(
        ...
        assert!(!raw.contains("/private/users/alice/.secrets/octet-shell"));
    }
