...
use octet_ai::{StreamEvent, Usage};
...
mod tests {
    use super::*;
    use octet_ai::{AssistantMessage, ModelId, Protocol, Response, StopReason, ToolCallId};
    ...
    fn lifecycle_feedback_does_not_change_context_state() {
        ...
        tracker.observe_stream(&StreamEvent::ProviderLifecycle(
            octet_ai::ProviderLifecycle {
