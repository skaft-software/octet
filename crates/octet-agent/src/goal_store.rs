...
//! implementation in `octet-agent` lets the terminal frontend use durable goals
...
mod tests {
    ...
    fn independent_processes_respect_goal_store_lock() {
        const CHILD_ENV: &str = "OCTET_GOAL_STORE_PROCESS_CHILD";
        const ROOT_ENV: &str = "OCTET_GOAL_STORE_PROCESS_ROOT";
        const READY_ENV: &str = "OCTET_GOAL_STORE_PROCESS_READY";
        const START_ENV: &str = "OCTET_GOAL_STORE_PROCESS_START";
        const DONE_ENV: &str = "OCTET_GOAL_STORE_PROCESS_DONE";
