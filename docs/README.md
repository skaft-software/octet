...
- [Basic usage](workflows.md)

<a id="using-octet"></a>

## Usage

- [Terminal, plain and print modes](terminal.md)
- [Commands and keyboard shortcuts](commands.md)
- [CLI options](cli.md)
- [Tools](tools.md)
...
- [0.7.4 UNPUBLISHED source candidate](releases/v0.7.4.md) — #382 physical gate open
