...
The [archived bridge record](reference/pi-compat/README.md) preserves historical
evidence only; it is not shipping code, an installation guide, or a release gate.
