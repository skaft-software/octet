...
version `0.7.6`; independent examples keep their own versions. The current host
source is a local 0.8.0 RC, not a published release. This is not SDK registry
publication. Version-matched assets and public-install verification belong to the
