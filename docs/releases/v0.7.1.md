...
A focused patch release candidate for plain-mode prompt presentation, trusted
release downloads, and model-supported auxiliary reasoning. Publication and
release verification are pending; the commands below are prospective.
...
retained-frame renderer must replay older changed rows.
